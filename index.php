    ...
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/img/slide/slide-1.jpg)">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/img/slide/slide-2.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/img/slide/slide-3.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
